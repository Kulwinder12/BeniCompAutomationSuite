...
public class ClientRepoold {
    ...
    public static By linkProfile = By.linkText("Profile");
    public static By linkContact = By.linkText("Contacts");
    public static By linkDivison = By.linkText("Divisions");
    public static By linkNotes = By.linkText("Notes");


    //Contact Screen

   // public static By btnAddcontact = By.xpath("//button[@title='Add Contact']");
   public static By btnAddcontact = By.xpath("//button[text()='Add Contact ']");
    ...
    public static By txtLastName = By.xpath("//input[contains(@formcontrolname, 'LastName')]");
    public static By txtCntctEmail = By.xpath("//input[contains(@formcontrolname, 'Email')]");
    public static By drpdwndivison = By.xpath("//form//label[.=' Division ']");
    ...
    public static By btnContactCancel = By.xpath("//h4[text()='Create Contact']//ancestor::div[2]//child::button[text()=' Cancel ']");
    public static By btnContactsave = By.xpath("//h4[text()='Create Contact']//ancestor::div[2]//child::button[text()=' Save ']");
